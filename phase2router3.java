...
public class phase2router3 {
  ...
  class Router {
   ...
   phase2router3(int routerval, int interfaceval){
   ...
   void BellmanFord(phase2router3 graph, int src) throws Exception{
   ...
   public static void main(String[] args) throws IOException, Exception {
         ...
         int clientRouterID = 3;
         int InitialCostTable[] = {3, 7, 2, 3};
         System.out.println("Initial Router3 Table: "); 
         ...
         int routerval = 4;
         int interfaceval = 5;
         phase2router3 table = new phase2router3(routerval, interfaceval);
         table.r[0].src = 0;
         table.r[0].dest = 1;
         table.r[0].cost = 1;
         table.r[1].src = 0;
