...
public class phase2router1 {
  ...
  class Router {
   ...
   phase2router1(int routerval, int interfaceval){
   ...
   void BellmanFord(phase2router1 graph, int src) throws Exception{
   ...
   public static void main(String[] args) throws IOException, Exception {
       ...
       int clientRouterID = 1;
       int InitialCostTable[] = {1, 1, 1, 3};
       System.out.println("Initial Router1 Table: "); 
       ...
       System.out.println("Waiting on client...\n");
        ...
        //use Bellman Ford algorithm to calculate shortest path.
         int routerval = 4;
         int interfaceval = 4;
         phase2router1 table = new phase2router1(routerval, interfaceval);
         table.r[0].src = 0;
         table.r[0].dest = 1;
         table.r[0].cost = 1;
         table.r[1].src = 0;
